...
const MOB_MODELS = {
    ...
    phantom: {
        ...
        texH: 64,//24.5
        parts: {
            body: {parent: null, pivot: [0, 24, 0], cubes: [{texOffs: [0, 8], from: [-2, -1, -17], size: [5, 3, 9]}]},
            head: {parent: 'body', pivot: [0, 23, -8], rot: [-12.5, 0, 0], emissiveOverlay: true, cubes: [{texOffs: [0, 0], from: [-4, -1, -5], size: [7, 3, 5]}]},
            ...
            wingRightBase: {parent: 'body', pivot: [-2, 26, -8], rot: [0, 0, -5], cubes: [{texOffs: [23, 12], from: [-6, -2, -9], size: [6, 2, 9]}]},
            wingLeftBase: {parent: 'body', pivot: [3, 26, -8], rot: [0, 0, 5], cubes: [{texOffs: [23, 12], from: [0, -2, -9], size: [6, 2, 9], mirrorU: ['up', 'down']}]},
            wingRightTip: {parent: 'wingRightBase', pivot: [-8, 26, -8], rot: [0, 0, -10], cubes: [{texOffs: [16, 24], from: [-13, -1, -9], size: [13, 1, 9]}]},
            wingLeftTip: {parent: 'wingLeftBase', pivot: [9, 26, -8], rot: [0, 0, 10], cubes: [{texOffs: [16, 24], from: [0, -1, -9], size: [13, 1, 9], mirrorU: ['up', 'down']}]},
        }
    },
    shulker: {
