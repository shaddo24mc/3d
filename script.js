...
const MOB_MODELS = {
    cow: {
        ...
        parts: {
            ...
            legFrontLeft:  { parent: null, pivot: [12, 4, -14],  cubes: [ { uvUp: [4, 16], uvDown: [8, 16], uvEast: [0, 20], uvWest: [8, 20], uvNorth: [4, 20], uvSouth: [12, 20], from: [-2, 18, -2], size: [4, 12, 4], mirrorU: ['north', 'west', 'east'] } ] },
    ...
    creeper: {
        ...
        parts: {
            ...
            legFrontRight: {parent: 'body', pivot: [6, 6, -4], cubes: [ {texOffs: [0, 16], from: [-2, 6, -2], size: [4, 6, 4]}]},
            legFrontLeft: {parent: 'body', pivot: [10, 6, -4], cubes: [ {texOffs: [0, 16], from: [-2, 6, -2], size: [4, 6, 4]}]},
