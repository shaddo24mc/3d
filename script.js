    ...
    if (hardcodedModels.has(bName)) {
      try {
        ...
        if (bName.includes('chest') && !bName.includes('right') && !bName.includes('left')) {
            ...
            const parts = [
                {size: [16, 16, 6], pos: [0, 3, -6], ...boxUV(0, 0, 16, 16, 6), pivot: [0, 3, 0], rot: [90, 0, 0], mirrorU: true, mirrorV: false},
            ...
            const parts = [
                {size: [16, 16, 6], pos: [0, 3, -6], ...boxUV(0, 22, 16, 16, 6), pivot: [0, 3, 0], rot: [90, 0, 0], mirrorU: true, mirrorV: false},
