      ...
      try {
        ...
        if (bName.includes('chest') && !bName.includes('right') && !bName.includes('left')) {
            ...
            const parts = [
                ...
                {size: [3, 3, 3], pos: [0, 0, 0], ...boxUV(50, 0, 3, 3, 3), pivot: [1.5, 1.5, 1.5], rot: [180, 90, 0], mirror: true, mirrorV: true, rotSouthNorth: true},
                {size: [3, 3, 3], pos: [13, 0, 0], ...boxUV(50, 6, 3, 3, 3), pivot: [14.5, 1.5, 1.5], rot: [180, -90, 0], mirror: true, mirrorV: true, rotSouthNorth: true}
            ]
            ...
            const parts = [
                ...
                {size: [3, 3, 3], pos: [0, 0, 13], ...boxUV(50, 12, 3, 3, 3), pivot: [1.5, 1.5, 14.5], rot: [180, 90, 0], mirror: true, mirrorV: true, rotSouthNorth: true},
                {size: [3, 3, 3], pos: [13, 0, 13], ...boxUV(50, 18, 3, 3, 3), pivot: [14.5, 1.5, 14.5], rot: [180, 180, 0], mirror: true, mirrorV: true, rotSouthNorth: true}
            ]
