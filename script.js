    ...
    if (hardcodedModels.has(bName)) {
      try {
        ...
        if (bName.includes('chest') && !bName.includes('right') && !bName.includes('left')) {
            ...
            const parts = [
                {size: [16, 16, 6], pos: [0, 3, -6], ...boxUV(0, 0, 16, 16, 6), pivot: [0, 3, 0], rot: [90, 0, 0], mirrorV: true},
                {size: [3, 3, 3], pos: [0, 0, 0], ...boxUV(50, 0, 3, 3, 3), rot: [180, 0, 0]},
                {size: [3, 3, 3], pos: [13, 0, 0], ...boxUV(50, 6, 3, 3, 3), rot: [180, 0, 0]}
            ]
            ...
            const parts = [
                {size: [16, 16, 6], pos: [0, 3, -6], ...boxUV(0, 22, 16, 16, 6), pivot: [0, 3, 0], rot: [90, 0, 0], mirrorV: true},
                {size: [3, 3, 3], pos: [0, 0, 0], ...boxUV(53, 12, 3, 3, 3), rot: [180, 0, 0]},
                {size: [3, 3, 3], pos: [13, 0, 0], ...boxUV(53, 18, 3, 3, 3), rot: [180, 0, 0]}
            ]
