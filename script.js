      ...
      try {
        ...
        if (bName.includes('chest') && !bName.includes('right') && !bName.includes('left')) {
            ...
            const parts = [
                ...
                {size: [3, 3, 3], pos: [0, 0, 13], ...boxUV(50, 12, 3, 3, 3), mirror: true, mirrorV: true, rotSouthNorth: true},
                {size: [3, 3, 3], pos: [13, 0, 13], ...boxUV(50, 18, 3, 3, 3), mirror: true, mirrorV: true, rotSouthNorth: true}
            ]
