    ...
    cow: {
        ...
        parts: {
            body: {
                ...
                rot: [-90, 0, 0],
                cubes: [ 
                    { texOffs: [18, 4], from: [-6, -10, -8], size: [12, 18, 10], mirrorU: ['up', 'down'], mirrorV: ['up']},
                    {texOffs: [52, 0], from: [-2, 2, -9], size: [4, 6, 1]}
                ]
            },
            head: {
                parent: null,
            ...
            legFrontRight: { parent: null, pivot: [4, 12, -7], cubes: [ { texOffs: [0, 16], from: [-2, 18, -2], size: [4, 12, 4] } ] },
            ...
            legBackRight:  { parent: null, pivot: [4, 12, -2],  cubes: [ { texOffs: [0, 16], from: [-2, 18, -2], size: [4, 12, 4] } ] },
            legBackLeft:   { parent: null, pivot: [-4, 12, -2],   cubes: [ { uvUp: [4, 16], uvDown: [8, 16], uvEast: [0, 20], uvWest: [8, 20], uvNorth: [4, 20], uvSouth: [12, 20], from: [-2, 18, -2], size: [4, 12, 4], mirrorU: ['north', 'west', 'east'] } ] }
        }
    },
