...
const MOB_MODELS = {
    ...
    strider: {
        ...
        parts: {
            ...
            bristlesRightMiddle: {parent: 'body', pivot: [-8, -9, 0], rot: [0, 0, -60], cubes: [{uvUp: [32, 49], uvDown: [32, 49], from: [-12, 0, -8], size: [12, 0, 16]}]},
            bristlesLeftMiddle: {parent: 'body', pivot: [8, -9, 0], rot: [0, 0, 60], cubes: [{uvUp: [32, 49], uvDown: [32, 49], from: [0, 0, -8], size: [12, 0, 16]}]},
            bristlesRightBottom: {parent: 'body', pivot: [-8, -4, 0], rot: [0, 0, -60], cubes: [{uvUp: [32, 64], uvDown: [32, 64], from: [-12, 0, -8], size: [12, 0, 16]}]},
            bristlesLeftBottom: {parent: 'body', pivot: [8, -4, 0], rot: [0, 0, 60], cubes: [{uvUp: [32, 64], uvDown: [32, 64], from: [0, 0, -8], size: [12, 0, 16], mirrorU: ['up']}]},
